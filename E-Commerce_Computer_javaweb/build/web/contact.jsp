...
<html lang="zxx">
    ...
    <head>
        ...
        <meta charset="UTF-8" />
        <meta name="keywords" content="VTO Store Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design"
              />
        <script>
                ...
                <div class="row main-top-w3l py-2">
                    ...
                    <div class="col-lg-8 header-right mt-lg-0 mt-2">
                        ...
                        <ul>
                            ...
                            <li class="text-center border-right text-white">
                                <i class="fas fa-phone mr-2"></i> 0964127981
                            </li>
                            <li class="text-center border-right text-white">
                                <a href="#" data-toggle="modal" data-target="#exampleModal" class="text-white">
            ...
            <div class="container">
                <div class="row header-bot_inner_wthreeinfo_header_mid">
                    ...
                    <div class="col-md-3 logo_agile">
                        ...
                        <img src="images/logo2.png" alt=" " class="img-fluid">VTO Store
                    </a>
                        </h1>
                    </div>
                    <!-- //logo -->
                ...
                <div class="row contact-grids agile-1 mb-5">
                    ...
                    <div class="col-sm-4 contact-grid agileinfo-6">
                        <div class="contact-grid1 text-center">
                            ...
                            <p>
                                <a href="mailto:vantoanvto@gmail.com">vantoanvto@gmail.com</a>
                                <label>
                                    <a href="mailto:kamananguyen@gmail.com">kamananguyen@gmail.com</a>
                                </label>
                            </p>
                        </div>
                    </div>
        ...
        <footer>
                ...
                <div class="container py-md-5 py-sm-4 py-3">
                    <div class="row footer-info w3-agileits-info">
                        ...
                        <div class="col-md-3 col-sm-6 footer-grids mt-md-0 mt-4">
                            ...
                            <ul>
                                <li class="mb-3">
                                    <i class="fas fa-map-marker"></i> C204R - FPT</li>
                                <li class="mb-3">
                                    <i class="fas fa-mobile"></i> 0964127981 </li>
                                <li class="mb-3">
                                    <i class="fas fa-phone"></i> 0392289089 </li>
                                <li class="mb-3">
            ...
            <div class="agile-sometext py-md-5 py-sm-4 py-3">
                <div class="container">
                    ...
                    <div class="sub-some mt-4">
                        <h5 class="font-weight-bold mb-2">Popular on VTO Store</h5>
                        <ul>
                            <li class="m-sm-1">
