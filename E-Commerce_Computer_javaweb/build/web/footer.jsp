<%-- 
    Document   : footer
    Created on : Feb 20, 2021, 5:45:57 PM
    Author     : ADMIN
--%>
...
<footer>
    <div class="footer-top-first">
        <div class="container py-md-5 py-sm-4 py-3">
            ...
            <h2 class="footer-top-head-w3l font-weight-bold mb-2">VanToan Computer :</h2>
...
<div class="copy-right py-3">
    <div class="container">
        <p class="text-center text-white">Công Ty Cổ Phần Thương Mại Máy Tính VanToan - Địa chỉ: C204R, Đại học FPT, Thạch Thất, Hòa Lạc, Thành Phố Hà Nội, Việt Nam.
            | Design by
            <a href="http://w3layouts.com"> Nguyễn Văn Toan</a>
        </p>
    </div>
</div>